...
// const bestMovie = dragnet => {
//   return dragnet + 'is the best movie ever!'
// }

const bestMovie = dragnet => `${dragnet} is the best movie ever!`
...
//CODE HERE
function moneyFrogs(gold){
  return gold / 3
}
 let totalFrogs = moneyFrogs(120)
...
/*
  ...
  You would just be able to purchase 1 product. Re-write the function you used in the previous problem (give it the same name, 
...
//CODE HERE
function moneyFrogs2(gold){
  return Math.floor(gold/3)
}

let totalFrogs2 = moneyFrogs2(4)
